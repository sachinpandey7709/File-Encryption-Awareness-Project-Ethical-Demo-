...
class RansomwareGUI:
    def __init__(self, master):
        ...
        master.config(bg="cyan")  # Dark background for hacker feel
        ...
        font_style = ("Courier New", 20)

        # Header Label
        self.header = tk.Label(master, text="Ransomware Attack", font=("Courier New", 25), fg="green", bg="white")
        self.header.pack(pady=10)

        # Target Folder Section
        tk.Label(master, text="Target Folder", font=font_style, fg="green", bg="white").pack()
        tk.Entry(master, textvariable=self.folder_path, font=font_style, width=40).pack(pady=5)
        tk.Button(master, text="Browse", font=font_style, command=self.browse_folder, bg="red", fg="green").pack(pady=5)
        ...
        tk.Radiobutton(master, text="Encrypt", variable=self.mode, value="encrypt", font=font_style, fg="green", bg="red", selectcolor="black").pack()
        tk.Radiobutton(master, text="Decrypt", variable=self.mode, value="decrypt", font=font_style, fg="green", bg="red", selectcolor="black").pack()

        # Start Button
        tk.Button(master, text="Start", font=font_style, command=self.start_process, bg="red", fg="cyan").pack(pady=10)

        # Status Label
        self.status = tk.Label(master, text="", font=font_style, fg="green", bg="white")
